...
import (
	"fmt"
	Sort "github.com/custergo/study_algo/3.Play-with-Algorithms/03-Sorting-Advance/Optional-03-ShellSort-MergeSort-and-QuickSort-Comparision"
	"testing"
)
...
func TestHeapSort1(t *testing.T) {
	...
	TestSort("HeapSort", HeapSort, arr6)
