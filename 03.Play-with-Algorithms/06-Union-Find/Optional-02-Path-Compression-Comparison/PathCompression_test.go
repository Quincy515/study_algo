...
import (
	"fmt"
	"github.com/custergo/study_algo/03.Play-with-Algorithms/06-Union-Find/Optional-02-Path-Compression-Comparison/UF5"
	"github.com/custergo/study_algo/03.Play-with-Algorithms/06-Union-Find/Optional-02-Path-Compression-Comparison/UF6"
	"testing"
)
