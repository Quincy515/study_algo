...
import (
	"fmt"
	"github.com/custergo/study_algo/01.Play-with-Data-Structures/14-Hash-Table/05-Hash-Table-Implementation/AVLTree"
	"github.com/custergo/study_algo/01.Play-with-Data-Structures/14-Hash-Table/05-Hash-Table-Implementation/BSTMap"
	"github.com/custergo/study_algo/01.Play-with-Data-Structures/14-Hash-Table/05-Hash-Table-Implementation/RBTree"
	"testing"
	"time"
)
...
func TestPProf(t *testing.T) {
	...
	// Test HashTable
	startTime = time.Now()
	ht := NewHashTable(1) // Total words:  124448
	for _, word := range words {
		if ht.Contains(word) {
